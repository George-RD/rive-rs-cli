...
- Interactive AuthoringSpec semantics: complete in PR #208. Curated cases drive authored inputs and pointer events through the official runtime, retain resolved interaction evidence, assert state-to-motion and transition wiring from authored identity, and gate visible frame response separately from runtime validity.
- Failure attribution: PRs #207 and #208 distinguish AuthoringSpec schema, lowering, structural, runtime, and semantic-mismatch stages while retaining AuthoringSpec diagnostics, lowered scene/source-map evidence, runtime interaction evidence, and rendered outputs.

## Dependencies

Runtime evidence and stable authored source maps are complete. Static/animated coverage completed in #182 / PR #207; interactive coverage completed in #183 / PR #208 on the same evidence model.

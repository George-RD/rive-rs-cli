...
2. #177 — canonical SceneSpec compilation seam used by raw `generate`, complete in
   PR #195.
3. #174 — first-class AuthoringSpec CLI input, implemented in PR #196.
4. #178 — prove the complex animated AuthoringSpec exit gate. This is the next
   frontier after PR #196 merges.

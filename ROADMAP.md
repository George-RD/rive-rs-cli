...
| P0 | [Repair duplicate-reference correctness defect](meta/todos/todo.repair-engine-modularization.md#immediate-correctness-gate) | implemented in PR #166; exact-head verification pending | duplicate-name repair cannot silently retarget an existing reference |
...
| P4 | [Repair-engine modularization](meta/todos/todo.repair-engine-modularization.md) | open after the bounded P0 fix; defer until Authoring compiler state is stable | characterization-preserving split aligned to authored source maps |

## Delivery dependencies

- Finish exact-head verification and merge PR #166; the next development session then starts the characterization stage of the one-pass Authoring compiler gate already recorded in the motion todo.
